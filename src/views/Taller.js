...
const Workplace = () => {
    return(
       ...
       <div className="headerWorkshop" >
            <img loading="lazy" className= "animate-on-scroll animate-right" src='/photos/taller2.webp' alt="headerWorkshop"></img>
       ...
       <div className="workshopCards">
        <div className="card animate-on-scroll animate-up">
                <img loading="lazy" src='/photos/taller-imagen-4.webp' alt="workshop1"></img>
                <p className="title">Torno CNC</p>
                <p className="description">720 x 2500</p>
            </div>
            <div className="card animate-on-scroll animate-up">
                <img loading="lazy" src='/photos/taller-imagen-6.webp' alt="workshop6"></img>
                <p className="title">Torno CNC</p>
                <p className="description">1030x900x3200</p>
            </div>
            <div className="card animate-on-scroll animate-up">
                <img loading="lazy" src='/photos/taller-imagen-2.webp' alt="workshop2"></img>
                <p className="title">Fresadora Vertical</p>
                <p className="description">1700x5000</p>
            </div>
            <div className="card animate-on-scroll animate-up">
                <img loading="lazy" src='/photos/taller-imagen-3.webp' alt="workshop3"></img>
                <p className="title">Centro Mecanizado CNC</p>
                <p className="description">1020 x 540 x 510 1 Ton</p>
            </div >
            <div className="card animate-on-scroll animate-up"  >
                <img loading="lazy" src='/photos/taller-image-1.webp' alt="workshop4"></img>
                <p className="title">Torno Convencional</p>
                <p className="description">700x2000</p>
                <p className="description"></p>
            </div>
            <div className="card animate-on-scroll animate-up">
                <img loading="lazy" src='/photos/taller-imagen-5.webp' alt="workshop5"></img>
